...
//		static final boolean doPrint = false;
		...
		void test1() throws Exception{
			String input = "x=1; repeat x=x+1 until x==4 return x";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		}
		...
		void test2() throws Exception{
			String input = "x=1; repeat x=x+1 if x==3 then break end until x==4 return x";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		}
		...
		void test4() throws Exception{
			String input = "x=6; while x>0 do x=x-1 goto label1 end ::label1:: x=10 return x";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		}
		...
		void test5() throws Exception{
			String input = "x=(1*(32+1)/2//7)^2 return x";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		}
		...
		void test6() throws Exception{
			String input = "x = \"xy\"; y = #x; a = 1; b = a>>2; return y,b;";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		}
		...
		void test7() throws Exception{
			String input = " x=1; y=(x == 2); z = not y; return y; ";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		}
		...
		void test8() throws Exception{
			String input = "if (\"a\"<\"bc\") then x = 1 end return x";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		}
		...
		void test9() throws Exception{
			String input = " a = print(x); b = \"sfdfsd\"; c = {a,b,true}; return d";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		}
		...
		void test10() throws Exception{
			String input = " x = 1; y = x~1; return y";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		}
		...
		void test11() throws Exception{
			String input = " x = 10; y = nil; a = x and y; b = x or y; return a,b";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		}
		...
		@Test
		void testPrintReturn() throws Exception{
		...
		@Test
		void testReturn1() throws Exception{
		...
		@Test
		void testReturn2() throws Exception{
		...
		@Test
		void testReturn3() throws Exception{
